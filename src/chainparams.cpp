        ...
        checkpointData = {
            {
                ...
                {5011, uint256S("b8308cf1068d52d55f0922b2b19579ca438f65943ce6fe4c1788a4403288441e")},
...
public:
    ...
    : CRegTestParams(args)
    {
        ...
        // YPO have 500 blocks of maturity, increased values for regtest in unit tests in order to correspond with it
