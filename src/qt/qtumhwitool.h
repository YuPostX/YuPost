...
/**
 * @brief The YuPostHwiTool class Communicate with the YuPost Hardware Wallet Interface Tool
 */
class YuPostHwiTool : public QObject
{
    Q_OBJECT
public:
    /**
     * @brief YuPostHwiTool Constructor
     * @param parent Parent object
     */
    explicit YuPostHwiTool(QObject *parent = nullptr);

    /**
     * @brief ~YuPostHwiTool Destructor
     */
    ~YuPostHwiTool();
