...
class YuPostStyle : public QProxyStyle
{
public:
    YuPostStyle()
    {
...
void StyleSheet::setStyleSheet(QApplication *app, const QString& style_name)
{
    ...
    YuPostStyle* yupostprojectStyle = new YuPostStyle;
    yupostprojectStyle->setBaseStyle(mainStyle);
    app->setStyle(yupostprojectStyle);
