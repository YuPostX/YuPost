...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("YuPosts");
    case mBTC: return QString("Milli-YuPosts (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-YuPosts (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
