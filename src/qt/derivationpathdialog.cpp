    ...
    ui(new Ui::DerivationPathDialog)
{
    ...
    ui->txtLegacy->setText(YuPostHwiTool::derivationPathPKH());
    ui->txtLegacy->setPlaceholderText(YuPostHwiTool::derivationPathPKH());
    ...
    ui->txtP2SH->setText(YuPostHwiTool::derivationPathP2SH());
    ui->txtP2SH->setPlaceholderText(YuPostHwiTool::derivationPathP2SH());
    ...
    ui->txtSegWit->setText(YuPostHwiTool::derivationPathBech32());
    ui->txtSegWit->setPlaceholderText(YuPostHwiTool::derivationPathBech32());
