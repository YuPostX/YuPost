...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " yupost-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  yupost-tx [options] <hex-tx> [commands]  Update hex-encoded yupost transaction\n" +
            "or:     yupost-tx [options] -create [commands]   Create hex-encoded yupost transaction\n" +
            "\n";
