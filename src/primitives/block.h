...
public:
    ...
    inline void SerializationOp(Stream& s, Operation ser_action) {
        ...
        READWRITE(nBits);
        READWRITE(nNonce);
        READWRITE(hashStateRoot); // yupost
        READWRITE(hashUTXORoot); // yupost
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // yupost
        hashUTXORoot.SetNull(); // yupost
    ...
    virtual bool IsProofOfStake() const //yupost
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //yupost
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //yupost
    {
