...
public:
    ...
    inline void SerializationOp(Stream& s, Operation ser_action) {
        ...
        READWRITE(nBits);
        READWRITE(nNonce);
        READWRITE(hashStateRoot); // yupostproject
        READWRITE(hashUTXORoot); // yupostproject
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // yupostproject
        hashUTXORoot.SetNull(); // yupostproject
    ...
    virtual bool IsProofOfStake() const //yupostproject
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //yupostproject
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //yupostproject
    {
