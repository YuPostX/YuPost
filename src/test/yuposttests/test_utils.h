...
inline void initState(){
    ...
    globalState = std::unique_ptr<YuPostState>(new YuPostState(dev::u256(0), YuPostState::openDB(dirYuPost, hashDB, dev::WithExisting::Trust), dirYuPost + "/yupostDB", dev::eth::BaseState::Empty));
