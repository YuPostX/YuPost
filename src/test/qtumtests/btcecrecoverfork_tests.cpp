...
//    initState();
    ...
    std::vector<YuPostTransaction> txBtcEcrecover;
    txBtcEcrecover.push_back(createYuPostTransaction(CODE[1], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createYuPostTransaction(CODE[2], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createYuPostTransaction(CODE[3], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createYuPostTransaction(CODE[4], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
