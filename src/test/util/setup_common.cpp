...
////////////////////////////////////////////////////////////// yupostproject
    ...
    boost::filesystem::path pathTemp = fs::temp_directory_path() / strprintf("test_yupostproject_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
    boost::filesystem::create_directories(pathTemp);
    const dev::h256 hashDB(dev::sha3(dev::rlp("")));
    globalState = std::unique_ptr<YuPostState>(new YuPostState(dev::u256(0), YuPostState::openDB(pathTemp.string(), hashDB, dev::WithExisting::Trust), pathTemp.string(), dev::eth::BaseState::Empty));
