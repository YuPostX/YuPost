...
const char * const BITCOIN_CONF_FILENAME = "yupostproject.conf";
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\YuPost
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\YuPost
    // Mac: ~/Library/Application Support/YuPost
    // Unix: ~/.yupostproject
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "YuPost";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/YuPost";
#else
    // Unix
    return pathRet / ".yupostproject";
#endif
#endif
}
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (copyright_devs.find("YuPost Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The YuPost Core Developers";
    }
