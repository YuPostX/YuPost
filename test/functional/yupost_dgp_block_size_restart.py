...
"""
Note, these tests do not test the functionality of the DGP template contract itself, for tests for the DGP template, see yupost-dgp.py
"""
class YuPostDGPActivation(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Restart the yupostd to verify that no crashes occurs on startup
        self.stop_nodes()
        self.start_nodes()
