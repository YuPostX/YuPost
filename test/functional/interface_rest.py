...
from test_framework.yupostprojectconfig import COINBASE_MATURITY, INITIAL_BLOCK_REWARD
...
class RESTTest (BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        not_related_address = convert_btc_address_to_yupostproject("2MxqoHEdNQTyYeX1mHcbrrpzgojbosTpCvJ")
